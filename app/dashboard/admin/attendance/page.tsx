...
export default function AttendancePage() {
  ...
  }, [reportFrom, reportTo, reportDepartmentId]);
  ...
  const reportSummary = useMemo(() => {
    ...
    return parts.join(" · ");
  }, [reportFrom, reportTo, reportDepartmentId, departments]);
  ...
  return (
    <div>
      ...
      {tab === "report" && (
        <div>
          <div className="mb-4 grid grid-cols-1 gap-3 rounded-xl border border-slate-200 bg-white p-4 print:hidden sm:grid-cols-4 dark:border-slate-800 dark:bg-slate-900">
            <div>
            ...
            <div className="sm:col-span-1">
              ...
              <SearchableSelect
                ...
                onChange={(opt) => setReportDepartmentId(opt ? (opt as SelectOption).value : "")}
                placeholder="All departments"
              />
            </div>
            <div className="flex items-end">
              <button onClick={handleExportPdf} className="flex w-full items-center justify-center gap-2 rounded-lg border border-slate-300 px-4 py-2.5 text-sm font-medium text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-200 dark:hover:bg-slate-800">
