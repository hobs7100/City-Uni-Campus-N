...
export async function GET(req:NextRequest){
  ...
  const student_rows=[...studentMap.values()].map(r=>{const percentage=r.total_marks?r.total_obtained/r.total_marks*100:0;return{...r,name:r.student_name,class:r.class_name,cells:r.test_values,percentage,overall_percentage:percentage,grade:ditGradeFromPercentage(percentage),zone:zone(percentage)}})
