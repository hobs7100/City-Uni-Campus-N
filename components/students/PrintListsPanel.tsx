  ...
  async function printReport() {
    ...
    try {
      ...
      const rowHtml = students.map((s) => `
        <tr><td>${escapePrintHtml(s.roll_no || "—")}</td><td><strong>${escapePrintHtml(s.name)}</strong><br><span class="father">Father: ${escapePrintHtml(s.father_name || "—")}</span></td><td class="writing"></td><td class="marks"></td></tr>
      `).join("");
      const html = `<!doctype html><html><head><meta charset="utf-8"><title>Award/Attendance List</title><style>
        @page{size:A4 portrait;margin:14mm 11mm}*{box-sizing:border-box}body{margin:0;color:#172033;font-family:Arial,sans-serif;font-size:11px}header{text-align:center;margin-bottom:12px}header img{width:64px;height:64px;object-fit:contain;margin-bottom:4px}h1{font-size:18px;margin:2px 0 11px;font-weight:700}.meta{display:grid;grid-template-columns:1fr 1fr;text-align:left;border:1px solid #aeb8c8;margin-bottom:12px}.meta div{padding:6px 8px;border-bottom:1px solid #d7dde6}.meta div:nth-child(odd){border-right:1px solid #d7dde6}.meta div:nth-last-child(-n+2){border-bottom:0}.label{font-size:9px;text-transform:uppercase;letter-spacing:.06em;color:#5c6a80;display:block;margin-bottom:2px}.value{font-weight:600}.total{margin:0 0 10px;text-align:right;font-weight:600}.line{display:inline-block;width:92px;border-bottom:1px solid #3c4655;height:12px;vertical-align:bottom}table{width:100%;border-collapse:collapse;table-layout:fixed}thead{display:table-header-group}tr{break-inside:avoid;page-break-inside:avoid}th{background:#e9edf4;font-size:10px;text-transform:uppercase;letter-spacing:.04em;color:#29364b}th,td{border:1px solid #8793a5;padding:6px 7px;text-align:left}th:nth-child(1),td:nth-child(1){width:13%}th:nth-child(2),td:nth-child(2){width:42%}th:nth-child(3),td:nth-child(3){width:25%}th:nth-child(4),td:nth-child(4){width:20%}.father{font-size:9px;color:#526078}.writing,.marks{height:30px}.signature{margin-top:28px;text-align:right}.signature .line{width:150px;margin-left:8px}.muted{color:#607089;font-size:9px;margin-top:15px}
